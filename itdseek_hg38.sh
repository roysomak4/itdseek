...
# pipeline SAM alignments to itdseek.pl (hg38 coordinates)
"$SAMTOOLS" view "$BAM" chr13:28033025-28035453 | "${SCRIPT_DIR}/itdseek.pl" --refseq "$REFSEQ" --samtools "$SAMTOOLS" --bam "$BAM"
